            ...
            <div class="lg:max-w-[1120px] mx-auto lg:px-[10px] md:px-[10px] px-0 lg:py-[20px] md:py-[20px] py-0">
                <div class="lg:flex md:flex hidden flex-row">
                    <div class="lg:min-w-[830px] md:min-w-[500px] bg-[#2e323bbf]"
                        :class="selectedTab1 == 'desc' ? 'h-[730px]' : 'h-[1181px]'">
                        <div class="w-full">
                        ...
                        <div class="">
                            <div class="relative py-[10px] px-4">
                                ...
                                <div class="absolute right-4 top-[25px]">
                                    <span class="text-[12px] leading-[16.8px] font-medium"
                                        :class="like ? 'text-white' : 'text-[#A0A0A0]'"
                                        @click="movieLike">
                                    ...
                                    <div class="tab-pane fade text-white" :class="selectedTab1 == 'desc' ? 'show active block' : 'hidden'"
                                        ...
                                        <div class="lg:mt-[40px] md:mt-[20px] lg:mx-[20px] md:mx-[15px] mx-[10px]
                                            ...
                                            <span class="text-[14px] text-[#15C3CA] leading-[19.6px] font-medium"
                                                ...
                                                {{ !showAllDesc ? $t("movie.expand") : $t("movie.shrink") }}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade text-white lg:h-[570px] md:h-[770px] h-[500px] overflow-y-auto px-4 w-full lg:min-w-[800px] md:min-w-[500px]"
                                        :class="selectedTab1 == 'discuss' ? 'show active block' : 'hidden'"
                                        id="tabs-discuss" role="tabpanel" aria-labelledby="tabs-discuss-tab">
                                        <div class="lg:my-[15px] md:my-[10px] my-[5px] py-[10px] px-[13px]">
                                            <p class="text-[#ffffff80] lg:text-[12px] md:text-[10px] text-[8px]
                                                mb-3 px-3 truncate">{{ replyDiscuss != null ? replyDiscuss.content : "" }}</p>
                                            <div class="flex">
                                                ...
                                                <div class="mr-[23px]">
                                                    <button class="bg-[#2C2C2C] rounded lg:text-[14px] md:text-[12px] text-[10px] text-white font-medium leading-[19.6px]
                                                        lg:w-[60px] md:w-[50px] py-[9px] px-4" @click="postComment">
                                                        {{ $t("movie.publish") }}
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div v-for="discuss in movie.discuss.list" :key="discuss.id"
                                            ...
                                            <div class="mr-2">
                                                <img :src="IMG_URL + '/upload/' + discuss.avatar" :alt="discuss.name" class="w-[36px] h-[36px]" />
                                            </div>
                                            <div class="grid grid-cols-2 lg:hidden md:hidden w-full">
                                                <div class="col-span-1">
                                                    <p class="text-[14px] text-[#999] leading-[19.6px]">{{ discuss.user_name }}</p>
                                                    <span class="text-[12px] text-[#666] mr-2">10-21</span>
                                                    <span class="text-[12px] text-[#666]"></span>
                                                </div>
                                                <div class="col-span-1">
                                                    <div class="flex justify-center items-center">
                                                        <span class="text-[#999] text-[12px] font-medium mr-[25px]">
                                                            <i class="far fa-thumbs-up text-[16px]"></i> {{ discuss.like_num }}
                                                        </span>
                                            ...
                                            <div class="lg:block md:block hidden w-3/4">
                                                <div>
                                                    <p class="text-[#FF9900] text-[14px] font-medium leading-[19.6px] mb-[9px]">{{ discuss.user_name }}</p>
                                                    <p class="text-white text-[14px] font-medium leading-[19.6px] mb-[11px]">{{ discuss.content }}</p>
                                                </div>
                                                <div class="grid grid-cols-3 lg:border-[#ffffff1a] md:border-[#ffffff1a] border-[#515151]
                                                    border-b-[0.2px]  pb-[24px]">
                                                    <div class="text-left">
                                                        <span class="text-[#666] text-[12px] leading-[16.3px] font-medium">
                                                            10-15·湖北
                                                        </span>
                                                        <span class="text-white text-[12px] leading-[16.3px] font-medium ml-2 cursor-pointer"
                                                            @click="() => selectReply(discuss)">
                                                            {{ $t("movie.reply") }}
                                                        </span>
                                                    </div>
                                                    <div class="text-right">
                                                        <span class="text-[12px] font-medium mr-[25px] text-right"
                                                            :class="likeList.includes(discuss.id) ? 'text-white': 'text-[#999]'"
                                                            @click="() => setLike(discuss.id)">
                                                            <i class="far fa-thumbs-up text-[16px]"></i> {{ discuss.like_num }}
                                                        </span>
                                                    </div>
                                                </div>
                    ...
                    <div class="lg:max-w-[300px] w-full lg:pt-[20px] md:pt-[15px] pt-[10px] lg:px-4 md:px-3 px-2">
                        <ul class="nav nav-tabs flex flex-row md:flex-row flex-wrap list-none border-b-0 pl-0 mb-4"
                            id="tabs-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <p class="text-white cursor-pointer lg:text-center md:text-center text-left
                        ...
                        <div class="overflow-y-auto"
                            :class="selectedTab1 == 'desc' ? 'h-[637px]' : 'h-[1116px]'">
                            <div class="tab-content overflow-y-auto" id="tabs-tabContent">
                                ...
                                <div class="tab-pane fade text-white overflow-y-auto px-4"
                                    ...
                                    <div class="lg:mt-5 md:mt-4 mt-3">
                                        <div class="lg:text-[12px] md:text-[10px] text-[8px] lg:leading-[24px] md:leading-[20px] leading-[16px]">
                                            <span class="text-[#A0A0A0]">{{ $t("movie.director") }}</span>
                                            <span class="text-white">{{ movie.detail.director }}</span>
                                        </div>
                                        <div class="lg:text-[12px] md:text-[10px] text-[8px] lg:leading-[24px] md:leading-[20px] leading-[16px]">
                                            <span class="text-[#A0A0A0]">{{ $t("movie.actor") }}</span>
                                            <span class="text-white">{{ movie.detail.actor }}</span>
                                        </div>
                                        <div class="lg:text-[12px] md:text-[10px] text-[8px] lg:leading-[24px] md:leading-[20px] leading-[16px]">
                                            <span class="text-[#A0A0A0]">{{ $t("movie.kind") }}</span>
                                            <span class="text-white">{{ movie.detail.kind }}</span>
                                        </div>
                                        <div class="lg:text-[12px] md:text-[10px] text-[8px] lg:leading-[24px] md:leading-[20px] leading-[16px]">
                                            <span class="text-[#A0A0A0]">{{ $t("movie.region") }}</span>
                                            <span class="text-white">{{ movie.detail.region }}</span>
                                        </div>
                                        <div class="lg:text-[12px] md:text-[10px] text-[8px] lg:leading-[24px] md:leading-[20px] leading-[16px]">
                                            <span class="text-[#A0A0A0]">{{ $t("movie.language") }}</span>
                                            <span class="text-white">{{ movie.detail.language }}</span>
                                        </div>
                                        <div class="lg:text-[12px] md:text-[10px] text-[8px] lg:leading-[24px] md:leading-[20px] leading-[16px]">
                                            <span class="text-[#A0A0A0]">{{ $t("movie.grade") }}</span>
                                            <span class="text-white">{{ movie.detail.grade ? movie.detail.grade.toFixed(1) : 0 + $t("movie.point") }}</span>
                                        </div>
                                        <div class="lg:text-[12px] md:text-[10px] text-[8px] lg:leading-[24px] md:leading-[20px] leading-[16px]">
                                            <span class="text-[#A0A0A0]">{{ $t("movie.times") }}</span>
                                            <span class="text-white">{{ movie.detail.times }}</span>
                                        </div>
                                        <div class="lg:text-[12px] md:text-[10px] text-[8px] lg:leading-[24px] md:leading-[20px] leading-[16px]">
                                            <span class="text-[#A0A0A0]">{{ $t("movie.duration") }}</span>
                                            <span class="text-white">{{ movie.detail.duration + " " + $t("movie.minutes") }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="lg:mt-[35px] md:mt-[28px] mt-[20px] overflow-y-auto">
                                <h3 class="lg:text-[20px] md:text-[17px] text-[14px] lg:leading-[28px] md:leading-[24px] leading-[20px]
                                    text-white font-medium lg:mb-[15px] md:mb-4 mb-3">{{ $t("movie.recommend") }}</h3>
                                <div v-if="movie.recommendList != null">
                                    <div class="mb-4" v-for="item in movie.recommendList" :key="item.id">
                                        <div class="flex">
                                            <img :src="IMG_URL + '/' + item.cover" :alt="item.title"
                                                class="max-w-[128px]" />
                                            <div class="px-1">
                                                ...
                                                <p class="mt-1 text-[#999] lg:text-[12px] md:text-[10px] text-[8px]"
                                                    :class="item.volumn == 1 ? 'hidden' : 'block'" v-if="item.times > 0">
                                                    {{ $t("movie.all") + item.times + $t("movie.volumn") }}
                                                </p>
                ...
                <div class="lg:hidden md:hidden block">
                    ...
                    <div class="pt-[10px] px-4 pb-[7px]">
                        <ul class="nav nav-tabs flex flex-row md:flex-row flex-wrap list-none border-b-0 pl-0 mb-4 relative"
                            ...
                            <span class="absolute top-[10px] right-0 text-[12px] leading-[16.8px] font-medium
                                lg:ml-[40px] md:ml-[20px] lg:hidden md:hidden block"
                                :class="like ? 'text-white' : 'text-[#B2B2B2]'"
                                @click="movieLike">
                        ...
                        <div class="tab-content" id="tabs-tabContent">
                                ...
                                <div class="mt-[10px]">
                                    ...
                                    <div class="grid grid-cols-2">
                                        <div>
                                            <span class="text-[#999] text-[12px] leading-[14px] font-medium mr-[16px]">
                                                ...
                                                {{ movie.detail.duration + " " + $t("movie.minutes") }}
                                            </span>
                                        ...
                                        <div class="text-right lg:hidden md:hidden block">
                                            <button class="text-[14px] text-[#999] leading-[19.6px] font-medium"
                                                @click="handleModal">
                                                {{ $t("movie.intro") }} <i class="fas fa-angle-right"></i>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="lg:mt-[26px] md:mt-[21px] mt-[16px] text-[#A0A0A0] text-[12px]
                                        ...
                                        <div class="flex flex-row">
                                            <div class="mr-2">{{ $t("movie.director") }}</div>
                                            <div> {{ movie.detail.director }}</div>
                                        </div>
                                        <div class="flex flex-row">
                                            <div class="mr-2 lg:w-[50px] md:w-[38px]">{{ $t("movie.actor") }}</div>
                                            <div> {{ movie.detail.actor }}</div>
                                        </div>
                                        <div class="flex flex-row">
                                            <div class="mr-2">{{ $t("movie.kind") }}</div>
                                            <div> {{ movie.detail.kind }}</div>
                                        </div>
                                        <div class="flex flex-row">
                                            <div class="mr-2">{{ $t("movie.region") }}</div>
                                            <div> {{ movie.detail.region }}</div>
                                        </div>
                                        <div class="flex flex-row">
                                            <div class="mr-2">{{ $t("movie.times") }}</div>
                            ...
                            <div class="tab-pane fade text-white w-full relative"
                                ...
                                <div class="h-[500px] overflow-y-auto">
                                    <div v-for="discuss in movie.discuss.list" :key="discuss.id"
                                        ...
                                        <div class="mr-2">
                                            <img :src="IMG_URL + '/upload/' + discuss.avatar"
                                                :alt="discuss.user_name" class="w-[36px] h-[36px]" />
                                        </div>
                                        <div class="grid grid-cols-2 lg:hidden md:hidden w-full">
                                            <div class="col-span-1">
                                                <p class="text-[14px] text-[#999] leading-[19.6px]">{{ discuss.user_name }}</p>
                                ...
                                <div class="w-full row relative">
                                    <div class="bg-[#515151] h-[1px] w-full"></div>
                                    <input type="text" class="rounded bg-[#2C2C2C] text-[14px] mt-[10px]
                                        text-[#ffffff80] p-[10px] w-full outline-none" v-model="comment" />
                                    <div class="absolute right-[10px] bottom-[8px]" @click="postComment">
                ...
                <div class="lg:mt-[52px] md:mt-[36px] mt-[20px] px-[10px]">
                    <div>
                        <h3 class="lg:text-[32px] md:text-[24px] text-[16px] lg:leading-[44.8px] md:leading-[35px] leading-[22.4px]
                            text-white lg:mb-[20px] md:mb-[15px] mb-[10px] font-bold">{{ $t("movie.youLike") }}</h3>
                        <div class="grid lg:grid-cols-6 md:grid-cols-6 grid-cols-3 gap-3">
                            <div v-for="item in movieList" :key="item.id"
                                class="relative cursor-pointer">
                                <router-link class="nav-link" :to="'/movie/' + item.id" :id="item.id" @click="() => getOtherMovie(item.id)">
                                    <div class="relative">
...
export default {
    ...
    methods: {
        ...
        getMovie(id) {
            ...
            var url = API_URL + "/api/v1/film/with-same-plot";
            this.axios.post(url, { "film_id": parseInt(id) }).then((res) => {
                if(res.status == 200) {
                    var data = res.data.data;
                    this.movie.detail = data.film;
                    this.movieUrl = this.videoUrl(data.film.url);
                    this.coverUrl = this.cover(data.film.cover);
                    this.movie.recommendList = data.list;
                }
            });
        },
        getMovieList() {
        ...
        getCommentList(id) {
            var url = API_URL + "/api/v1/film/comment/list";
            var params = {
                film_id: parseInt(id),
                ID: 1,
                page_num: 0,
            ...
            this.axios.post(url, params).then((res) => {
                if(res.status == 200) {
                    this.movie.discuss.list = res.data.data;
                    this.movie.discuss.count = res.data.data.length;
                }
            });
        },
        toggleBtn: function () {
        ...
        selectReply(discuss) {
            this.replyDiscuss = discuss;
        },
        postComment() {
            var params = {
                film_id: this.movie.detail.id,
                reply_id: this.replyDiscuss != null ? this.replyDiscuss.id : 0,
            ...
            var url = API_URL + "/api/v1/film/comment/post";
            this.axios.post(url, params, config).then((res) => {
                if(res.status == 200) {
                    this.getCommentList(this.movie.detail.id);
                    this.comment = "";
        ...
        setLike(discussId) {
            var undo = false;
            if(this.likeList.includes(discussId)) {
                undo = true;
                this.likeList.splice(this.likeList.indexOf(discussId), 1);
            } else {
                this.likeList.push(discussId);
            }
            var params = {
                id: discussId,
                undo: undo
            ...
            var url = API_URL + "/api/v1/film/comment/like";
            this.axios.post(url, params, config).then((res) => {
                if(res.status == 200) {
                    this.getCommentList(this.movie.detail.id);
                }
        ...
        movieLike() {
            ...
            if(this.like) {
                this.like = !this.like;
                url += "/api/v1/film/dislike";
            } else {
                this.like = !this.like;
                url += "/api/v1/film/like";
            }
            this.axios.post(url, params, config).then((res) => {
                if(res.status == 200) {
                    this.getMovie(this.movie.detail.id);
                }
            });
        }
    },
